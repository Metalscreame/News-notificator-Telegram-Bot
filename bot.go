...
func (b *Bot) AnnaMessageParser(msg *tgbotapi.Message) (string, interface{}) {
	...
	case Start:
		...
		return `Я бот. Я был создан для того, чтобы поведать тебе сказку о принцессе Анне и об одном парне, который создал меня. Иногда он любит писать код и играть на гитаре, А зовут его Р… .Впрочем ты и так уже, наверное, знаешь кто он. Что ж… Начнем? Shall we?`, mrkup
	case "Начать":
	...
	case "Рома":
		...
		m := `По имени Рома. Рома очень хотел поздравить Аню с днем рождения и очень хотел вызвать на её прекрасном лице улыбку радость в её сердце. И он очень хотел произвести на неё впечатление. И он задумал сделать кое-что, ибо он как-то услышал это от принцессы, когда они общались вместе на берегу одной известной реки...`
		mrkup := tgbotapi.NewReplyKeyboard([]tgbotapi.KeyboardButton{button1})
		return m, mrkup
	case "Далее":
		...
		m := "Принцесса сидела в своей башне и слушала пение птиц, как вдруг одна птичка залатела прям к ней в окно, села на подоконник рядом с ней и уставилась на неё. Это был ручной птенчик Ромы. Она его уже раньше встречала. Принцесса заметила, что у птенца на ноге была привязана бумага. Раскрыть бумагу?"
		mrkup := tgbotapi.NewReplyKeyboard([]tgbotapi.KeyboardButton{button1, button2})
		return m, mrkup
	case "Да":
		return `Хороший выбор! Принцесса раскрыла бумагу. Бумага немного пахла знакомым запахом. Один странный парень время от времени любил брызгать свои любиые духи на некоторые вещи. В этот раз он себе тоже не отказал в этом. Принцесса узнала этот запах и засмеялась. Она начала читать записку и вот то, что было написано на записке: "С Днем рождения, милая принцесса! https://youtu.be/6H-InGqgKzo". Вот и сказочке конец, а кто слушал... Тот самый лучший на свете человек <3. Ну а что до меня... то я самоуничтожусь через какое-то время как терминатор в Терминатор 2... шутка :)`, nil
	case "Нет":
